...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
MagMin(1:Nelements,1)=0;
MagMax(1:Nelements,1)=1;
PhsMin(1:Nelements,1)=0;
PhsMax(1:Nelements,1)=pi;
EnforceSymmetry=1; % 1 for symmetric distrib, 0 for asymmetric
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Pattern Goals
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
UpperSidelobeGoal_u= [-1 -.065 -.045 .045 .065 1 ];
UpperSidelobeGoal_dB=[-50 -35 0 0 -35 -50];
LowerSidelobeGoal_u= [ -1 -.036 -.036 .036 .036 1];
LowerSidelobeGoal_dB=[-80 -75 -1 -1 -75 -80];
AutomaticallyExemptMainBeam=0; % 1 to exempt main beam from goals
NPatternPoints=512;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
S
avePopulationAverageScore(ii)=mean(CurrentGenerationScores);
